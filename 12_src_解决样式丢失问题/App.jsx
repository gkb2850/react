            ...
            <div className="col-xs-2 col-xs-offset-2">
              <div className="list-group">
                ...
                {/* NavLink默认给选中的加上active类名 如果想改就加activeClassName */}
                  <MyNavLink to="/atguigu/a/home">Home</MyNavLink>
                  <MyNavLink to="/atguigu/a/about">About</MyNavLink>
              </div>
            </div>
            <div className="col-xs-6">
              <div className="panel">
                <div className="panel-body">
                  ...
                  <Switch>
                    <Route path="/atguigu/a/about" component={About} />
                    <Route path="/atguigu/a/home" component={Home} />
                  </Switch>
